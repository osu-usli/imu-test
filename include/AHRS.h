...
#define MPU6050_DMP_UPDATE1_SIZE    5
#define MPU6050_DMP_UPDATE2_SIZE    7
#define MPU6050_DMP_UPDATE3_SIZE    5
#define MPU6050_DMP_UPDATE4_SIZE    11
#define MPU6050_DMP_UPDATE5_SIZE    7
#define MPU6050_DMP_UPDATE6_SIZE    5
#define MPU6050_DMP_UPDATE7_SIZE    7
...
public:
	...
	void writeMPURegister(byte reg, byte val);
	byte readMPURegister(byte reg);
	unsigned readMPU16(byte regHigh);
	
	//void writeCompassRegister(byte reg, byte val);
	//byte readCompassRegister(byte reg);
...
private:
    unsigned lastXAccel[5];
    unsigned lastYAccel[5];
    unsigned lastZAccel[5];
    double lastXGyro[5];
    double lastYGyro[5];
    double lastZGyro[5];
    byte bufferIndex;
